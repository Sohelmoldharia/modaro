<?php
	...
	$manga_single_summary       = MangazScans::getOption( 'manga_single_summary', 'on' );
    ...
    $info_summary_layout = MangazScans::getOption('manga_profile_summary_layout', 1);;
?>
    ...
    <div class="content-area">
        <div class="container">
            <div class="row <?php echo esc_attr( $mz_single_sidebar == 'left' ? 'sidebar-left' : '' ) ?>">
                <div class="main-col <?php echo esc_attr( $mz_single_sidebar !== 'full' && ( is_active_sidebar( 'manga_single_sidebar' ) || is_active_sidebar( 'main_sidebar' ) ) ? ' col-md-8 col-sm-8' : 'col-md-12 col-sm-12 sidebar-hidden' ) ?>">
                    ...
                    <div class="main-col-inner">
						...
						<?php
							...
							if ( class_exists( 'WP_Manga' ) ) {
                                $setting = MangazScans::getOption('manga_single_tags_post', 'info');
				...
				<?php
					if ( $mz_single_sidebar != 'full' && ( is_active_sidebar( 'main_sidebar' ) || is_active_sidebar( 'manga_single_sidebar' ) ) ) {
						?>
