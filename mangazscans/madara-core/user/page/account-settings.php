	...
	<?php if( $account_resp !== null ){ ?>
		<?php if ( ! is_wp_error( $account_resp ) ) { ?>
	        <div class="alert alert-success alert-dismissable">
	            ...
	            <strong><?php esc_html_e( 'Succeeded!', 'mangazscans' ); ?></strong> <?php esc_html_e( 'Update successfully', 'mangazscans' ); ?>
	        </div>
		<?php } else { ?>
	        <div class="alert alert-danger alert-dismissable">
	            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
	            <strong><?php esc_html_e( 'Failed!', 'mangazscans' ); ?></strong> <?php echo esc_html( $account_resp->get_error_message() ); ?>
	        </div>
		<?php } ?>
	<?php } ?>
    ...
    <div class="tab-group-item">
        <div class="tab-item">
            ...
            <div class="form form-choose-avatar">
                <div class="select-flie">
                    <!--Update Avatar -->
                    <form action="#">
						<?php esc_html_e( 'Only for .jpg .png or .gif file', 'mangazscans' ); ?>
                        <label class="select-avata">
							<input type="file" name="wp-manga-user-avatar">
							<span class="file-name"></span>
						</label>
							
                        <input type="submit" value="<?php esc_html_e( 'Upload', 'mangazscans' ); ?>" name="wp-manga-upload-avatar" id="wp-manga-upload-avatar">
                    </form>
        ...
        <div class="tab-item">
            ...
            <div class="settings-title">
                <h3>
					<?php esc_html_e( 'Change Your Display name', 'mangazscans' ); ?>
                </h3>
            </div>
            <div class="form-group row">
                <label for="name-input" class="col-md-3"><?php esc_html_e( 'Current Display name', 'mangazscans' ); ?></label>
                <div class="col-md-9">
            ...
            <div class="form-group row">
                <label for="name-input" class="col-md-3"><?php esc_html_e( 'New Display name', 'mangazscans' ); ?></label>
                <div class="col-md-9">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input class="form-control" type="submit" value="<?php esc_html_e( 'Submit', 'mangazscans' ); ?>" id="name-input-submit" name="account-form-submit">
                </div>
            </div>
        ...
        <div class="tab-item">
            <div class="settings-title">
                <h3>
					<?php esc_html_e( 'Change Your email address', 'mangazscans' ); ?>
                </h3>
            </div>
            <div class="form-group row">
                <label for="email-input" class="col-md-3"><?php esc_html_e( 'Your email', 'mangazscans' ); ?></label>
                <div class="col-md-9">
            ...
            <div class="form-group row">
                <label for="email-input" class="col-md-3"><?php esc_html_e( 'New email address', 'mangazscans' ); ?></label>
                <div class="col-md-9">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input class="form-control" type="submit" value="<?php esc_html_e( 'Submit', 'mangazscans' ); ?>" id="email-input-submit" name="account-form-submit">
                </div>
            </div>
        </div>
        <div class="tab-item">
            <div class="settings-title">
                <h3>
					<?php esc_html_e( 'Change Your Password', 'mangazscans' ); ?>
                </h3>
            </div>

            <div class="form-group row">
                <label for="currrent-password-input" class="col-md-3"><?php esc_html_e( 'Current Password', 'mangazscans' ); ?></label>
                <div class="col-md-9">
                    <input class="form-control" type="password" value="" id="currrent-password-input" name="user-current-password">
                </div>
            </div>
            <div class="form-group row">
                <label for="new-password-input" class="col-md-3"><?php esc_html_e( 'New Password', 'mangazscans' ); ?></label>
                <div class="col-md-9">
                    <input class="form-control" type="password" value="" id="new-password-input" name="user-new-password">
                </div>
            </div>
            <div class="form-group row">
                <label for="comfirm-password-input" class="col-md-3"><?php esc_html_e( 'Comfirm Password', 'mangazscans' ); ?></label>
                <div class="col-md-9">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <label id="checkbox-weak-password" style="display:none"><input type="checkbox" id="agree-weak-password" /><?php esc_html_e('I agree to use this weak password', 'mangazscans');?></label>
                    <input class="form-control" type="submit" value="<?php esc_html_e( 'Submit', 'mangazscans' ); ?>" id="password-input-submit" name="account-form-submit">
                </div>
            </div>
        </div>
    </div>
